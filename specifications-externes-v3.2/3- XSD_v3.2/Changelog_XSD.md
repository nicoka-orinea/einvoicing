## Modifications apportées sur les XSD entre les versions publiées dans les spécifications externes v3.1 du PPF (30/10/2025) et les versions publiées en v3.2 des spécifications externes (30/04/2026)

### XSD E-invoicing

F1BASE_CrossIndustryInvoice_ReusableAggregateBusinessInformationEntity_100pD22B : 

* Mise en commentaire des éléments /rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem (BG-25)

### XSD E-Reporting

ereporting.xsd :

* Suppression de l'attribut xmlns:ereporting
